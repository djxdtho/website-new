...
function SocialIcons() {
  return (
    <>
      ...
      <a href="https://instagram.com/dndloldesigner" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors duration-300 p-3 -m-3" aria-label="Instagram">
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      <a href="https://tiktok.com/@dndloldesigner" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors duration-300 p-3 -m-3" aria-label="TikTok">
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    <>
      ...
      <section id="about" className="relative z-10 min-h-dvh flex items-center py-24 px-6">
        <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 md:gap-20">
          {/* Left: visual */}
          <Card data-grid-size="lg" className="md:sticky md:top-24 md:self-start aspect-square flex items-center justify-center overflow-hidden">
            <motion.span
